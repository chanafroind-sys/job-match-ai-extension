...
# Shared declarative Base — the same metadata alembic/env.py autogenerates
# from. A private Base here hid this table from autogenerate.
...
class DailyJobPool(Base):
    ...
    # Refreshed on every sync that still sees the job — /jobs/matched-pool
    # treats a recent scraped_at as "still open".
